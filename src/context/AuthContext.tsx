      ...
      try {
        ...
        if (firebaseUser) {
          try {
            ...
            // Don't rethrow here to allow app to load for non-auth users
            setUser(null);
          }
        } else {
          setUser(null);
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 gap-4">
        ...
        <p className="text-slate-500 font-bold animate-pulse uppercase tracking-widest text-xs">Carregando AgroMarket...</p>
      </div>
    );
  }
